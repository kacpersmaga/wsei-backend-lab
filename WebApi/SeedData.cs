...
public static class SeedData
{
    public static void Seed(this WebApplication app)
    {
        using (var scope = app.Services.CreateScope())
        {
            ...
            QuizItem item4 = new QuizItem(id: 0, question: "What is the capital of France?", correctAnswer: "Paris", incorrectAnswers:
                ["London", "Berlin", "Madrid"]);
            QuizItem item5 = new QuizItem(id: 0, question: "What is 3 squared?", correctAnswer: "9", incorrectAnswers:
                ["6", "12", "15"]);
            QuizItem item6 = new QuizItem(id: 0, question: "What is the largest planet?", correctAnswer: "Jupiter", incorrectAnswers:
                ["Saturn", "Earth", "Mars"]);
            quizItemRepo?.Add(item4);
            quizItemRepo?.Add(item5);
            quizItemRepo?.Add(item6);
            Quiz quiz2 = new Quiz(id: 0, title: "General Knowledge", items: [item4, item5, item6]);
            quizRepo?.Add(quiz2);
        }
    }
}